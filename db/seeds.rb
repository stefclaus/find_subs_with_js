...
Yogaclass.create(name: 'Yoga 1.5 at 8pm Saturday', time: '8am', weekday: 'Saturday', instructor: 'Sally Smith')
Yogaclass.create(name: 'Yoga 1.5 at 10am Sunday', time: '10am', weekday: 'Sunday', instructor: 'Sarah Smith')
Yogaclass.create(name: 'Pilates at 6pm Thursday', time: '6pm', weekday: 'Thursday', instructor: 'Sarah Smith')
Yogaclass.create(name: 'Beginners Yoga at 8pm Thursday', time: '8pm', weekday: 'Thursday', instructor: 'Emma Silverman')
